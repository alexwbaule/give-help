...
CREATE TABLE IF NOT EXISTS PROPOSAL_VIEWS (
  ...
  ProposalID VARCHAR(128) REFERENCES PROPOSALS(ProposalID),
  UserID VARCHAR(128) DEFAULT '', --EMPTY VALUES ARE ALLOWED
  CreatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  Description TEXT DEFAULT ''
);
CREATE INDEX IDX_PROPOSAL_VIEWS_PROPOSALID ON PROPOSAL_VIEWS (ProposalID);
